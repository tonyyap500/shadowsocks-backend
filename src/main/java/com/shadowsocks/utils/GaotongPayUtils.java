...
public class GaotongPayUtils {
	...
	private static String buildSign(GaotongPayDto dto) {
		String signPattern = "partner=%s&banktype=%s&paymoney=%f&ordernumber=%s&callbackurl=%s%s";
	...
	public static String buildPaymentURL(GaotongPayDto dto) {
		...
		String gaotongURLPattern = "https://wgtj.gaotongpay.com/PayBank.aspx?banktype=%s&partner=%s&paymoney=%f&ordernumber=%s&callbackurl=%s&hrefbackurl=%s&attach=%s&sign=%s";
